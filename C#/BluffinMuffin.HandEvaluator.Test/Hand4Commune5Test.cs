...
namespace BluffinMuffin.HandEvaluator.Test
{
    ...
    public class Hand4Commune5Test
    {
        ...
        {
            var res = HandEvaluators.Evaluate( new[] {"Ks", "5h", "10h", "Qc"}, new[] {"8d", "Ac", "7s", "6s", "2s"});
        ...
        {
            var res = HandEvaluators.Evaluate( new[] {"Ks", "Kh", "Qh", "Qc"}, new[] {"8d", "Ac", "7s", "6s", "2s"});
            Assert.IsNotNull(res);
        ...
        {
            var res = HandEvaluators.Evaluate( new[] {"Ks", "5h", "10h", "Qc"}, new[] {"8d", "8c", "7s", "7c", "2s"});
            Assert.IsNotNull(res);
            Assert.AreEqual(HandEnum.TwoPairs, res.Hand);
        ...
        {
            var res = HandEvaluators.Evaluate( new[] {"Js", "5h", "2h", "Qc"}, new[] {"8d", "8c", "7s", "7c", "2s"});
            Assert.IsNotNull(res);
            Assert.AreEqual(HandEnum.TwoPairs, res.Hand);
            Assert.AreEqual(NominalValueEnum.Eight, res.Cards.First().First().Value);
            Assert.AreEqual(NominalValueEnum.Seven, res.Cards.Skip(1).First().First().Value);
        ...
        {
            var res = HandEvaluators.Evaluate( new[] {"Ks", "Kh", "Qh", "Qc"}, new[] {"8d", "2c", "7s", "6s", "2s"});
            Assert.IsNotNull(res);
            Assert.AreEqual(HandEnum.TwoPairs, res.Hand);
            Assert.AreEqual(NominalValueEnum.King, res.Cards.First().First().Value);
            Assert.AreEqual(NominalValueEnum.Queen, res.Cards.Skip(1).First().First().Value);
        ...
        {
            var res = HandEvaluators.Evaluate( new[] {"Js", "5h", "7h", "Qc"}, new[] {"8d", "8c", "7s", "7c", "2s"});
            Assert.IsNotNull(res);
        ...
        {
            var res = HandEvaluators.Evaluate( new[] {"Js", "5h", "3h", "Qc"}, new[] {"7d", "8c", "7s", "7c", "2s"});
            Assert.IsNotNull(res);
            Assert.AreEqual(HandEnum.ThreeOfAKind, res.Hand);
            Assert.AreEqual(NominalValueEnum.Seven, res.Cards.First().First().Value);
            Assert.AreEqual(NominalValueEnum.Queen, res.Cards.Skip(1).First().First().Value);
        ...
        {
            var res = HandEvaluators.Evaluate( new[] {"5s", "5h", "3h", "5c"}, new[] {"7d", "8c", "Js", "Qc", "2s"});
            Assert.IsNotNull(res);
            Assert.AreEqual(HandEnum.ThreeOfAKind, res.Hand);
        ...
        {
            var res = HandEvaluators.Evaluate( new[] {"5s", "4h", "3h", "Ac"}, new[] {"7d", "8c", "Js", "Qc", "2s"});
            Assert.IsNotNull(res);
        ...
        {
            var res = HandEvaluators.Evaluate( new[] {"5s", "4h", "3h", "Ac"}, new[] {"7d", "10c", "Js", "Qc", "Ks"});
            Assert.IsNotNull(res);
            Assert.AreEqual(HandEnum.Straight, res.Hand);
            Assert.AreEqual(NominalValueEnum.Ace, res.Cards.First().First().Value);
            Assert.AreEqual(1, res.Cards.Count);
        ...
        {
            var res = HandEvaluators.Evaluate( new[] {"5s", "4h", "Qh", "As"}, new[] {"7d", "10s", "Js", "Qs", "Ks"});
            Assert.IsNotNull(res);
